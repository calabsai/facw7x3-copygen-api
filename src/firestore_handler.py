...
def load_system_role_prompt(db):
    try:
        ...
        field_value = doc.get("systemRoleEmailCopywriterV2_2023050211459")
...
def load_email_prompt(db, selected_template):
    ...
    doc = doc_ref.get()
    field_name = {
        "email-template-1": "em_001_outcome_focused_u_s",
        "email-template-2": "em_002_emotional_impact_s",
        "email-template-3": "em_003_niche_expertise_m_b"
